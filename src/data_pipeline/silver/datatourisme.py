...
def transform_silver(raw_entries: list[dict], left: float=None, right: float=None, bottom: float=None, top: float=None) -> gpd.GeoDataFrame:
    """
    ...
    if left is not None and right is not None and bottom is not None and top is not None:
